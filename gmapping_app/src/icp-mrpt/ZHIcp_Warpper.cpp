...
void CICPWarpper::setDebugWindowOn()
{
    skip_window = false; 
}
void CICPWarpper::setDebugWindowOff()
{
    skip_window = true;
}
...
float CICPWarpper::ICPMatch(float* rx, float* ry, int N1, float* ax, float* ay, int N2, double pini[3], double pout[3])
{
