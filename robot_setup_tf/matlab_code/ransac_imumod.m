function [n_match, rs_match, cnum] = ransac_imumod(frm1, frm2, match, x1, y1, z1, x2, y2, z2, imu_rot)
...
%[rs_rot, rs_trans, rs_sta] = find_transform_matrix_imumod(rs_pset1, rs_pset2,imu_rot);
[rs_rot, rs_trans] = eq_point(rs_pset1, rs_pset2,imu_rot); 
pset21 = imu_rot*pset2;
for k=1:pnum
