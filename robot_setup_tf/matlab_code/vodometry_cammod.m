function [rot, trans, GoodFrames1, GoodFrames2, psn, nMatches, match, SolutionState] = vodometry_cammod(x1,x2,y1,y2,z1,z2,img1_d,img2_d)
...
[rot, trans] = eq_point_vo(op_pset1, op_pset2);
sta=1;
